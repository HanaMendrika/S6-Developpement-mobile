...
class ProduitsViewModel : ViewModel() {
    ...
    // => Parce que si c’était MutableStateFlow, l’interface pourrait changer l’état elle‑même. Avec StateFlow,
    // l’UI peut seulement observer. Ça empêche l’interface de casser le flux unidirectionnel.
    // -----------------------------------------------------------------------
